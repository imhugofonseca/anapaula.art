...
const Loading = ({ fadeOut }) => (
    <Overlay className={fadeOut && `fadeOutBro`}>
        <AnimatedBrand >
            <Svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="180px" height="180px" viewBox="0 0 2180 1820" preserveAspectRatio="xMidYMid meet" className={fadeOut && `animated zoomOut`}>
